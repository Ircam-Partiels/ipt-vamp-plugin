...
Download the IPT Vamp plugin installation package for your operating system from the [Releases](https://github.com/Ircam-Partiels/ipt-vamp-plugin/releases) section and run the installer.
